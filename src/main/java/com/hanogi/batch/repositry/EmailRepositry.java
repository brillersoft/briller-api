...
public interface EmailRepositry extends CrudRepository<Email, String> {
	...
	public static final String EMAIL_Domian_Query = "SELECT * from EMAILID where EMAILID.email_domain_id=?1 ";

	@Query(value = EMAIL_Domian_Query, nativeQuery = true)
	public List<Email> findByEmailDomailDetails(Integer emailDomainId);
}
